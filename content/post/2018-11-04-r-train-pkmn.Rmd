...
I've embedded the document below so you can skim it, but you should [visit the page where it's hosted in all its glory](https://matt-dray.github.io/beginner-r-feat-pkmn/) for the authentic experience.

`r knitr::include_app("https://matt-dray.github.io/beginner-r-feat-pkmn/", height = "400px")`
