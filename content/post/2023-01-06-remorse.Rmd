...
It reminded me of one (of many) unwritten micro-projects I've got kicking around in my brain: obviously you could use {sonify} to communicate Morse Code. And why not translate from text to Morse (and back) while you're at it?
...
Note that not all characters can be converted to Morse Code. I did some research (Wikipedia) to discover the mappings from letters, numbers and punctuation to Morse Code and the information is used internally to the package and also exported in `morse_lookup`:
...
But of course it does so much more. Well, one thing more. Lets go from Morse to audio:
...
Wow. It plays audible dits (one time unit), dahs (three), spaces between dits and dahs (one), spaces between Morse character groupings (three) and spaces between words (seven). Tell all your friends.

So, do I still feel remorse for writing {remorse} after demonstrating its power? Yes. All I ask is that you think of me in those apocalyptic wastelands.
