...
How can you write a quick RStudio Addin? I demonstrate with [a tiny R package I wrote called {backtick}](https://github.com/matt-dray/backtick), which contains an RStudio Addin with a handful of functions for inserting backticks into your R scripts and R Markdown documents (yes, really).
...
To solve Calum's problem ([and Italy's?](https://commons.wikimedia.org/wiki/File:Italian_Keyboard_layout.svg)), you could try to use [a custom keyboard shortcut](https://t.co/JxZuhfbl2P) perhaps, or maybe [a snippet](https://t.co/aZakMQ3Nvu). And RStudio already has a button and shortcut in its IDE for inserting R Markdown code chunks, which require triple backticks to demarcate the start and end of the chunk.
