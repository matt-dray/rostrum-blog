...
To solve Calum's problem ([and Italy's?](https://commons.wikimedia.org/wiki/File:Italian_Keyboard_layout.svg)[^italy]), you could try to use [a custom keyboard shortcut](https://t.co/JxZuhfbl2P) perhaps, or maybe [a snippet](https://t.co/aZakMQ3Nvu). And RStudio already has a button and shortcut in its IDE for inserting R Markdown code chunks, which require triple backticks to demarcate the start and end of the chunk.
