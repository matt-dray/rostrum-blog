...
You can also set the functions of an RStudio Addin to custom keyboard shortcuts and quickly access them from [the RStudio command palette](https://www.rstudio.com/blog/rstudio-v1-4-preview-command-palette/) (just hit <kbd>Shift</kbd> + <kbd>Cmd</kbd> + <kbd>P</kbd>, or <kbd>Shift</kbd> + <kbd>Ctrl</kbd> + <kbd>P</kbd>, then <kbd>`` ` ``</kbd>).
...
#' Insert Backtick
#'
#' Insert a single backtick. In an  R Markdown file, one backtick will be inserted.
