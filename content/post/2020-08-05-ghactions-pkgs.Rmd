...
1. Set-up an empty 'gh-pages' branch in your repo ([the book has some code to do this from the command line](https://ropenscilabs.github.io/actions_sandbox/websites-using-pkgdown-bookdown-and-blogdown.html){target="_blank"})
