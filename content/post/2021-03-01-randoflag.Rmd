...
My needs were simple: show a mystery flag; reveal who it belongs to; refresh.[^spork] So I built a little [{shiny}](https://shiny.rstudio.com/) app, put it in [a GitHub repo](https://github.com/matt-dray/randoflag) and [served it](https://www.mattdray.shinyapps.io/randoflag/).
