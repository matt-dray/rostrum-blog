...
* [Duncan's `gg_beeswarm_emoji()` tweet](https://twitter.com/nacnudus/status/1063147043861000193)
* [`ggbeeswarm` on GitHub](https://github.com/eclarke/ggbeeswarm)
* [`emoGG` on GitHub](https://github.com/dill/emoGG)
