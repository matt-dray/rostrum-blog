...
I thought I'd go with something a bit more... _naïve_. Simple enough for my little game (for now). And no maths!
...
The map started with four randomly-selected floor tiles; these were joined with straight, right-angled corridors; then three iterations expanded out the floor space from the existing floor tiles.
