...
rmd_files <- rmd_html %>% 
  ...
  mutate(rmd_filepath = glue("https://github.com/matt-dray/rostrum-blog/commits/master/content/post/{rmd_filename}"))
```



history in the form
https://github.com/matt-dray/rostrum-blog/commits/master/content/post/file-name.Rmd
date
relative-time
