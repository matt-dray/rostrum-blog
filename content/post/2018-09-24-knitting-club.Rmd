...
RAP has generated interest among analysts across government regardless of whether they produce statistical publications. One useful tool for this purpose is [R Markdown](https://rmarkdown.rstudio.com/), which allows you to execute R code inside your document and 'knit' it into a readable report. You can re-run the code, or alter the parameters and re-knit it without stress. This is much faster and less error-prone versus a workflow that moves data between a database, spreadsheet and word processor.
...
I presented was created to support a cross-department Coffee & Coding session. The blurb was:
...
I put together a much small presentation that distils longer-form document. You can see the slides below, [access them online](https://matt-dray.github.io/quick-rmd/#1), or find [the code on GitHub](https://matt-dray.github.io/quick-rmd/).
