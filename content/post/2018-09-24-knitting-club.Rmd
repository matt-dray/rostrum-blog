...
I've embedded the document below for you to skim it, but [you should access it in full online](https://matt-dray.github.io/knitting-club/) and find [the code on GitHub](https://github.com/matt-dray/knitting-club). 

`r knitr::include_app("https://matt-dray.github.io/knitting-club/", height = "400px")`
