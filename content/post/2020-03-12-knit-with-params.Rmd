...
I made a demo, [Ninja Knitting](https://www.github.com/matt-dray/ninja-knitting){target='_blank'}, focusing on parameterised [{xaringan}](https://slides.yihui.org/xaringan/#1){target='_blank'} slides that require further iteration with `pagedown::chrome_print()` to render from HTML to PDF.
