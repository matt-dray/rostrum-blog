...
This interactive graphic shows the publishing frequency.[^mobile] There's been [27 posts](https://www.rostrum.blog/), so about one every two weeks. 
...
[^mobile]: Turn to landscape mode if you're viewing on mobile so the graphic fits.