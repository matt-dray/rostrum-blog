...
<div class="figure">
<img src="/post/2023-04-02-splendid-r-games_files/snes-r.png" alt="A crudely drawn image of the buttons from a Nintendo SNES controller, but the A, B, X and Y labels have all been changed to R." width="100%"/>
</div>
