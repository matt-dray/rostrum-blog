...
What does it do? It posts a satellite image of a random bit of Greater London every half hour. just take in the aesthetics of spaghetti streets intermingled with green space, or you can try to guess where it is. For example, what's the location of this image from [an existing \@londonmapbot tweet](https://twitter.com/londonmapbot/status/1309199157530431489?s=20)?[^clue]
