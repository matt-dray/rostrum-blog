...
We're using [an image of a dandelion from Wikimedia Commons](https://commons.wikimedia.org/wiki/Flowers#/media/File:L%C3%B6wenzahn-JJ5.jpg).
...
So we could get the values of each colour channel for the top-left nine pixels of the image (a three-by-three matrix).
