...
I've written [the concept R package {tamRgo}](https://github.com/matt-dray/tamRgo) to simulate a persistent digital pet in your R console. Yes, really.

# GameRs

R is a game engine. Look no further than [Mike Cheng's rstudio::conf22 talk](https://www.youtube.com/watch?v=LPotWAJnE_s) or the [awesome-r-games list](https://github.com/matt-dray/awesome-r-games).

I've written things like  [{ActionSquirrel}](https://github.com/matt-dray/ActionSquirrel), [{safar6}](https://github.com/matt-dray/safar6) and [{r.oguelike}](https://github.com/matt-dray/r.oguelike).

<div class="figure">
<img src="/post/2022-10-29-tamRgo_files/space-meme.jpg" alt="The 'always has been meme'. An astronaut looks at Earth and says 'wait, R is a language for making and playing games' and an astronaut behind them, who is pointing a gun at their head, says 'always has been'." width="100%"/>
</div>

Is it possible to persist a game state over different sessions? Could this allow for a _Tamagotchi_-like digital pet to live on your computer? Spoiler: yes.

# Tamagotchwhat?

For the benefit of youths, [a _Tamagotchi_](https://en.wikipedia.org/wiki/Tamagotchi) was (is!) a little physical device that contains a 'digital pet', made popular in the late 90s. They have a little screen and physical buttons so you can see your pet and interact with it. Play with it, feed it, even reprimand it.
...
You are free to destroy this file by navigating to the path resolved by `tools::R_user_dir("tamRgo", "data")` or, 
