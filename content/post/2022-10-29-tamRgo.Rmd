...
Let's quickly check what our pet looks like with `see_pet()`. Its appearance depends on the species and the level; newborns are pretty much a blob, but your pet will grow and develop as it levels. The quality of the 'sprite' rendering will depend on the settings in your console, but hopefully you get the idea.
...
After some time, your pet will become 'dirty', represented by a small pile of filth underneath your their sprite.
...
Almost as big as KEVIN himself, wow. You'll just need to `clean()` it away.
