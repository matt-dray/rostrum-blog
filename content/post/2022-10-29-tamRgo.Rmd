...
Let's quickly check what our pet looks like with `see_pet()`. Its appearance depends on the species and the level, but newborns are pretty much a blob. It'll probably render better in your R console than in your browser.
...
Maybe you forgot about your pet (whoops) and three days later you remember that it exists. From any R session on your computer you can check the stats.
...
Pay attention to the status values. Look after your pet! Apparently there's a chance it might become... 'unalive'. Rumour has it that good owners have longer-living pets...
