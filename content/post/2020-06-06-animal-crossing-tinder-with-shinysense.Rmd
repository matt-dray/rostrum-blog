...
Who's the most popular [Animal Crossing: New Horizons](https://en.wikipedia.org/wiki/Animal_Crossing:_New_Horizons){target='_blank'} villager? I made [an R Shiny app](https://mattdray.shinyapps.io/acnh-swipe/){target='_blank'} where you swipe right if you like a randomly-presented villager and left if you dislike them.
...
It's also [hosted for free on shinyapps.io](https://www.shinyapps.io/), so there's a limited number of uptime hours it can use per month.
