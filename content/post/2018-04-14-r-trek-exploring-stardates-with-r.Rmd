...
Download the [Star Trek: The Next Generation](https://en.wikipedia.org/wiki/Star_Trek:_The_Next_Generation) scripts from the [Star Trek Minutiae](http://www.st-minutiae.com/resources/scripts/#thenextgeneration) website. These are provided in a zipped folder with 176 text files -- one for each episode.
...
We can make this interactive with `plotly`.

```{r dotplot_interactive}
