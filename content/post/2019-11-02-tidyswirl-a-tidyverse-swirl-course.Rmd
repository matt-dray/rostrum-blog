...
![](/post/2019-11-02-tidyswirl-a-tidyverse-swirl-course_files/tidyswirl.gif)
...
<div class="figure">
<img src="/post/2019-11-02-tidyswirl-a-tidyverse-swirl-course_files/tidyswirl.jpg" alt="A yellow post-it note with a design for a hexagonal sticker with 'tidyswirl' written on it, surrounded by small swirly shapes of different colours." width=200 />
...
I started with these packages because of the relatively limited number of functions compared to other packages and because they're invovled typically in the early stages of a data analysis workflow.

Try iy by installing Swirl and Tidyswirl:
...
Tidyswirl is unlikely to be finished anytime soon but it seems worth letting people know it exists. It'd be great for you to contribute to a lesson, write a new one about one of the other tidyverse packages, or reported any issues or bugs.
  - swirl
  - swirlify
  - tidyverse
  - tidyswirl
