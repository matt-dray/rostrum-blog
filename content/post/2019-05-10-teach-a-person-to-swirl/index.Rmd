...
<p class="caption">A metaphor for all the {swirl} courses you'll make (via [Giphy](https://giphy.com/gifs/cookie-swirl-depositor-LJpWh180LBOF2))</p>
</div>
...
<img src="/post/2019-05-10-teach-a-person-to-swirl_files/swirl-startup-console.png" alt="The R console showing input to Swirl and some responses, like Swirl asks 'What shall I call you?' and 'Matt' has been input.">
...
<img src="/post/2019-05-10-teach-a-person-to-swirl_files/swirlify-start.png" alt="The Swirlify Shiny GUI for writing lessons, showing a dropdown box for the lesson type, a box for writing output, the YAML code for the lesson so far, and buttons for saving and demoing the code.">
...
<img src="https://media.giphy.com/media/TKMV1MbB5z1iw0SbeM/giphy.gif" alt="A gif showing the process of creating a question with Swirlify's Shiny GUI, adding it to the YAML for the lesson and then saving it.">
...
<img src="/post/2019-05-10-teach-a-person-to-swirl_files/tidyswirl.JPG" alt="A post-it note with a crudely-drawn hex sticker that says 'Tidyswirl' across the centre, with small differently-coloured swirl shapes in the remaining space." width=220 height=200/>
