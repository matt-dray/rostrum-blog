...
I've written [a package with a single function](https://github.com/matt-dray/badgr){target='_blank'}---`badgr::get_badge()`---that generates a URL for a [shields.io](https://shields.io){target='_blank'} badge, which can then be placed in a repo's README.
