...
[Note: The original version of this post (December 2018) used [the {gmapsdistance} package](https://github.com/rodazuero/gmapsdistance){target='_blank'}. I updated it extensively in June 2020 to use the {osrm} package, which doesn't require an API key nor billing details.]
