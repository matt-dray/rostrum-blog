...
PokéAPI provides a [relatively simple API](https://pokeapi.co/docs/v2). Sign-up and API tokens aren't required and you can only read ('GET') data from it.
...
Do not be surprised if function names or general functionality change in future.
...
Join me next time as I continue my quest to write (sometimes) useful R packages that help me squat all the remaining spots on Repokémon.
...
{pokeWrapper}](https://nguyeneva.github.io/2020-02-06-rwrapper/), but these appear smaller in scope and haven't been updated for a while.