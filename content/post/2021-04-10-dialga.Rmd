...
The format required for the values in these slots can be expressed relatively easily as R code, which is what `r2cron()` uses as input. For example, this table shows how cron translates to R for the minutes slot: 
