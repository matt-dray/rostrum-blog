...
You too can fork [the source for londonmapbot on GitHub](https://github.com/matt-dray/londonmapbot), or click the green 'use this template' button in the repo to begin your own mapbot. Or can you can create something from scratch. Let me know what you get up to.
