...
You may have heard of the object-oriented systems [S3](https://adv-r.hadley.nz/s3.html){target='_blank'} and [S4](https://adv-r.hadley.nz/s4.html){target='_blank'} in R; R6 provides another, newer implementation of OOP. There are two important things to know about R6 objects. To simplify, they're:
