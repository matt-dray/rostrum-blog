...
If you're thinking this approach is a bit long-winded, you're right. As [Tim pointed out](https://twitter.com/_TimTaylor_/status/1431387715728248834?s=20), we could just extract the info via [METACRAN](https://github.com/cran), an unofficial CRAN mirror hosted on GitHub. It even has [its own API](https://www.r-pkg.org/services#api). I'll probably give that a go at some point.
</div>
