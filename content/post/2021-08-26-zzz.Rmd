...
<div class="figure">
<img src="/post/2021-08-26-zzz_files/multicolor-startup.png" alt="A screenshot of the R console showing the output from when the multicolor package is attached. It's cursive ASCII-art text of the package name, coloured with random colours." width=500/>
</div>
...
And perhaps the most self-aware were several packages that reminded the user that they can turn off startup messages with `suppressPackageStartupMessages()` if it the messages get too annoying (e.g. {dendextend}).
