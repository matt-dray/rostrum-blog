...
Rather than recreate his artworks exactly, I decided to riff on the approach with a Shiny app, which adds different types of lines and adds some randomisation into the mix. You can access it here: [![](https://img.shields.io/badge/Shiny-shinyapps.io-blue?style=flat&labelColor=white&logo=RStudio&logoColor=blue)](https://mattdray.shinyapps.io/lewitt-remix-app/)
...
[^box]: This is drawn on a panel-by-panel basis, so the interior boxes appear thicker because of the additive effect of surrounding boxes.