...
1. `r emo::ji("pie")` [Everyone loves pie charts](https://duckduckgo.com/?q=pie+charts+suck), particularly when they're in 3D, exploded and tilted.
2. `r emo::ji("cloud")` [Word clouds aren't at all overused](https://duckduckgo.com/?q=word+clouds+suck).
3. `r emo::ji("shrug")` I have too much time on my hands.
...
Did I forget to mention that it defaults to a rainbow colour palette and gothic typeface? The words and pie slices are sized by frequency and match up by colour. *Sensational*.
