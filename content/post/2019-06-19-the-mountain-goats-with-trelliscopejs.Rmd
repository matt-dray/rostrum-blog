...
You can follow the instructions in the previous post to get the data. I'm going to load those data from an [RDS file](https://www.r-bloggers.com/remember-to-use-the-rds-format/) on my machine.
