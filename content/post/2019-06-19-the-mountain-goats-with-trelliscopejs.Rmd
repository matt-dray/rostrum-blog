...
I used [{trelliscopejs}](https://hafen.github.io/trelliscopejs/) to make an interactive display for [The Mountain Goats](http://www.mountain-goats.com/) discography. You can interact with it below or [click here to open full screen](https://www.rostrum.blog/output/goat-scope/){target="_blank"}.
...
I've embedded here the output, but [you can click here to open full screen](https://www.rostrum.blog/output/goat-scope/).
