...
But wait: [Matthew Kay](https://twitter.com/mjskay) has written [the {explodeAssign} package](https://github.com/mjskay/explodeAssign), which lets you use special down-assign arrows in an interactive session! As Matthew says, it's a 'terrible idea' and you should 'explode-assign at your own risk', lol.
