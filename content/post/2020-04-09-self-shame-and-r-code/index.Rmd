...
Past-Matthew was using this approach because he was taught with [Mick Crawley's R Book](https://www.wiley.com/en-gb/The+R+Book%2C+2nd+Edition-p-9780470973929){target='_blank'}. Mick says `attach()` 'makes the code easier to understand for beginners' (page 18)[^beginner] --- possibly because expressions end up looking less cluttered. But this only sets up beginners (like me) for problems later. In fact, Mick even says, perhaps confusingly, to 'avoid using attach wherever possible' in his book.
