...
run_days <- left_join(
  ...
  workouts_out %>% 
    filter(km > 1, date > "2020-03-23" & date < "2021-03-22") %>%
    distinct(date) %>%
    mutate(run = 1),
  by = "date"
...
calendR(
  start_date = "2020-03-23", end_date = "2021-03-22",
  start = "M", special.days = run_days$run,
  gradient = TRUE, low.col = "white", special.col = "red",
  title = "Running days", subtitle = "2020-03-23 to 2021-03-22 inclusive",
  day.size = 1, weeknames.size = 2.5
)
