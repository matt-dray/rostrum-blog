...
![Example of command line inputs and outputs](/post/2019-02-01-git-going-cl_files/terminal-example.png)
...
This post is a basic introduction to the command line. Here are some commonly-used commands:
...
![The Nano text editor running from the command line](/post/2019-02-01-git-going-cl_files/nano-example.png)
...
![](https://media.giphy.com/media/Ive85Xdzhpg8E/giphy.gif)