...
![I'm-a Luigi, number one (at the command line) ([via Giphy](https://giphy.com/gifs/luigi-Cie9cWGeqVYHe))](https://media.giphy.com/media/Cie9cWGeqVYHe/source.gif)

```{r setup, include=FALSE}
knitr::opts_chunk$set(eval = FALSE)
```

# TL;DR: basic command-line 

These are likely to be your most commonly-used bash commands.
