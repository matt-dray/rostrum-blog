...
You could use the .Rprofile to display a little message at startup.
...
The following code selects one element at random from a character vector of motivational messages and prints it to the console on startup.
...
![Random messages selected from the .Rprofile on restart](/post/2019-01-04-rprofile-motivate_files/rprofile-restart.png)
