...
I used [the {itdepends} R package](https://github.com/r-lib/itdepends) to see how CRAN packages depend on [{lubridate}](https://lubridate.tidyverse.org/), which [was not removed from CRAN](What if [the {lubridate} package was removed from CRAN](https://github.com/tidyverse/lubridate/issues/998)?) recently.
...
I see the benefit of minimising dependencies. I also understand the drawbacks of reinventing the wheel. Maybe {lubridate} is a good dependency: a clean API, part of the well-known tidyverse and it handles stuff you can't be bothered with, like what's 29 February plus one year?
