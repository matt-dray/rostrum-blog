...
# at the else statement. That's weird because the funciton works when run
...
<div class="figure">
<img src="/post/2021-03-12-assign_files/cmm.png" alt="A man sits at a table with a banner that has on it R's left assignment operator (<-) and underneath it says 'change my mind'." width="75%"/>
</div>
