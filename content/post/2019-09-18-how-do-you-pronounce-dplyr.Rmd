...
Of course, there are other text-to-speech engines, which may interpret and synthesise words differently. For example, [`espeak`](https://en.wikipedia.org/wiki/ESpeak) vocalises {dplyr} as 'deepler'.
