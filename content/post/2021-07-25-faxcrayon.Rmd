...
Where to get inspiration? I've tweeted images for #RecreationThursday using the fax[^fax] `r emo::ji("fax")` and crayon `r emo::ji("crayon")` emojis because I was using my rudimentary skills to create facsimile copies of original artworks. So... fax crayon? Like a wax crayon, but, like, fax? 
