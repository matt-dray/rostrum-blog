...
The [{bs4lib}](https://bs4cards.djnavarro.net/articles/introduction.html) package (available on CRAN) is great because it lets you create customisable 'cards' that you can tile on an R Markdown page.
...
So I did just that: [I made a single page](https://github.com/matt-dray/faxcrayon)[^site] where each card displays an art piece I created with R code for [#RecreationThursday on Twitter](https://twitter.com/search?q=%23recreationthursday) or whatever, the date it was created, the 'name' of the piece, and whether its is a recreation of an original artwork, a remix (like extending or corrupting an artist's vision) or something that fell out of my own coding process (i.e. abstract or vaguely eye-pleasing stuff).
