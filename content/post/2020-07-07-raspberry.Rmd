...
There's [a full walkthrough for setting up your machine](https://projects.raspberrypi.org/en/projects/raspberry-pi-setting-up){target='_blank'} on the Raspberry Pi website.
...
A prerequisite for Nvim-R is either [Vim](https://www.vim.org/){target='_blank'} or [Neovim](https://neovim.io/){target='_blank'}. Nvim-R is a plugin for these tools.

But what are they, actually? Vim is [a powerful text editor](https://en.wikipedia.org/wiki/Vim_(text_editor)){target='_blank'} for the command line and Neovim is [effectively a more extensible version of it](https://en.wikipedia.org/wiki/Vim_(text_editor)#Neovim){target='_blank'}.
...
We can install a plugin manager to help install and manage Nvim-R and other Neovim extensions: [vim-plug](https://github.com/junegunn/vim-plug){target='_blank'} by Junegunn Choi. 
...
I found [a YouTube video](https://www.youtube.com/watch?v=nm45WagtV3w){target='_blank'} and a [GitHub gist](https://gist.github.com/rohitfarmer/68cdadeaeeb196e8a6ecdebdee6e76a5) by [Rohit Farmer](https://rohitfarmer.github.io/){target='_blank'} really useful for doing these steps. Rohit provides some good examples of additional plugins that will improve your experience of Nvim-R.
...
Instead, I used [snapcraft](https://snapcraft.io/){target='_blank'}, which describes itself as 'the app store for Linux'. It bundles up everything you need for a given installation, including dependencies. This is great for a noob like me.
...
Setting up a blog is out of scope for this post, but you can find instructions for this in the [blogdown companion book](https://bookdown.org/yihui/blogdown/){target='_blank'} by Yihui Xie, Amber Thomas and Alison Presmanes Hill. 
