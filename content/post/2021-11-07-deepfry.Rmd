...
1. Adjusts the image contrast, saturation, etc,[^adjust] and then compresses it horribly
1. Outputs a `magick-image` object that you can save with `magick::image_write()` and send to all your friend
...
What spicy meme shall I make? Well, the `=` versus `<-` assignment-operator flamewar[^flamewar] has been cold for a few days, so time to heat it up again. And why not incorporate the world's most famous fry cook?
