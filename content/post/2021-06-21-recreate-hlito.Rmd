...
I chose to use base R plotting functions for this project. Largely for the simplicity and for the lack of dependencies, but also due to [success I had recently when recreating another artwork](https://www.rostrum.blog/2021/06/08/recreate-spear/).
...
There's some great remixes on the #RecreationThursday hashtag and I particularly liked the ones that went for slight variations in stroke and placement, as well as those with an animated approach.
...
There's a number of ways to present these 'rando-Hlitos'. I thought it would be interesting to do two things: create a large grid of many recreations (i.e. see many recreations at once) and create an animation (i.e. a sequential reveal of many recreations). I think these are interesting in different ways.
