...
<img src="/post/2019-05-19-package-a-xaringan-template_files/gdstheme-template.gif" alt="A gif that cycles through the slides that make up the gdstheme xaringan template, including heading slides, text slides and annotated image slides.">
...
<iframe src="https://matt-dray.github.io/gdstheme/" width="500" height="375" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
...
<img src="/post/2019-05-19-package-a-xaringan-template_files/heading-slide.png" alt="The heading slide, which is blue with large white overlaid text reading 'this is a heading slide'.">
...
<img src="/post/2019-05-19-package-a-xaringan-template_files/heading-image-slide.png" alt="The image heading slide, which has a background image of some documents with large black overlaid text reading 'this is an image heading slide'.">
...
<img src="/post/2019-05-19-package-a-xaringan-template_files/monospace.png" alt="Google Fonts web page showing a line of code rendered in some different monospace fonts so they can be compared.">
...
<img src="https://raw.githubusercontent.com/matt-dray/gdstheme/master/img/new-rmd.png" alt="The 'New R Markdown' window with the 'From Template' option selected and 'Slide template for GDS' highlighted in the 'Template' section.">
