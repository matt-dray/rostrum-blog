...
![The heading slide has bold text on a blue background](/post/2019-05-19-package-a-xaringan-template_files/heading-slide.png)
...
![A heading-class slide using the black tag for better text-image contrast](/post/2019-05-19-package-a-xaringan-template_files/heading-image-slide.png)
...
![Google Fonts page showing some monospace fonts to choose from](/post/2019-05-19-package-a-xaringan-template_files/monospace.png)
