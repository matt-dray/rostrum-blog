...
It's almost like this post could have just been a tweet saying '🤭 yo, `type.conversion()` is 🪄magic🪄 y'all'. But this post is now a handy reference in case anyone has the same problems with Excel's handling of {a11ytables} outputs in future.
