...
Nah, instead I hacked together a little function that can be run on startup to warn me if I have multiple RStudio sessions open with the same name. It's called `check_rproj_dupes()`.
...
Here it is (or see it [in a GitHub Gist](https://gist.github.com/matt-dray/b4ff92f01093f512dae99b670e3eddb7)):
