...
There have been `r nrow(posts)` posts on the blog between `r min(posts$publish_date)` (the first) and `r max(posts$publish_date)` (the most recent).
...
<details><summary>Click for full list of posts</summary>
```{r}
posts %>%
